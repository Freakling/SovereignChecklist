...
For each question, assign status:
- Fully controlled  
...
**Time to degradation**
How long can you tolerate losing this dependency?
...
Losing a dependency for a short period is a different problem from losing it permanently. This helps distinguish tolerable risk from unacceptable risk.

**Risk ownership**
Who carries the operational and business risk when the dependency fails.
Not just who fixes it and not just who is impacted. It is the combination of accountability and consequence.
Document Risk consequences in comments or outside this document based on your own ways of working.

- Your team
- Another internal team
- A vendor/customer

Use the comments column to capture context, assumptions, decisions, etc.

---

## 1. Control plane and infrastructure dependency

| Question | Status | Time to degradation | Risk owner | Comments / Actions |
|----------|--------|---------------------|------------|--------------------|
